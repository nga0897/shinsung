...
namespace Mvc_VD.Extensions
{
    public static class StringExtensions
    {
        ...
        public static int FormatNumberIntTryParse(int? intNumber)
        {
            int subMenuIdConvert;
            if (intNumber == null)
            {
                return 0;
            }
            var ddd = intNumber.ToString();
            var dddd = int.TryParse(ddd, out subMenuIdConvert);
            return subMenuIdConvert;
        }
        ...
        public static string FormatOne(string index)
        {
            if (string.IsNullOrEmpty(index))
            {
                return "";
            }
            return index.Substring(0, 1) + Convert.ToInt32(index.Substring(1, 10));
        }
        public static string FormatTwo(string index)
        {
            if (string.IsNullOrEmpty(index))
            {
                return "";
            }
            return index.Substring(0, 2) + Convert.ToInt32(index.Substring(2, 9));
        }
        ...
        public static int Count_hour(TimeSpan start, TimeSpan end)
        {
            TimeSpan timeSpan1 = start;
            TimeSpan timeSpan2 = end;
            var timeDiff = timeSpan2.Subtract(timeSpan1);
            var hour = timeDiff.Hours;
            if (hour < 0)
            {
                hour = 0 - timeDiff.Hours;
            }

            return hour;
        }
        public static int Count_Minute(TimeSpan start, TimeSpan end)
        {

            TimeSpan timeSpan1 = start;
            TimeSpan timeSpan2 = end;
            var timeDiff = timeSpan2.Subtract(timeSpan1);
            var minute = timeDiff.Minutes;
            if (minute < 0)
            {
                minute = 0 - timeDiff.Minutes;
            }
        ...
        public static List<string> ListTimeInDays_CMS()
        {
            var times = new List<string>
            {
                "00:00",
