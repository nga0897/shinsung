$grid = $("#list").jqGrid({
    ...
    colModel: [
        ...
        //{ label: 'Actual', name: 'actual', width: 60, align: 'right' },
        { label: 'Quantity Material(m)', name: 'm_lieu', width: 120, align: 'right' },
        //{ label: 'Efficiency(%)', name: 'HS', width: 60, align: 'right' },
...
function Product_view(e) {
    ...
    ////var ret = jQuery("#list").jqGrid('getRowData', at);
    //window.open("/TIMS/TIMSDaily?at=" + e.dataset.at_no + "&id_actual=" + e.dataset.id_actual);
}
