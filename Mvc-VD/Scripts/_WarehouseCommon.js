               ...
               $('.delete-btn').click(function () {
                   ...
                   $.ajax({
                       ...
                       success: function (result) {
                           $("#WHSCommonGrid").setGridParam({ datatype: "json" }).trigger('reloadGrid');
...
$(function () {
   ...
   ({
       ...
       colModel: [
           ...
           { label: 'Main Name', name: 'mt_nm', width: 120, align: 'center' },
           { label: 'Detail Code', name: 'dt_cd', width: 100, align: 'left' },
           ...
           if (iCol == 9) {
               $('.delete-btn').click(function () {
                   ...
                   $.ajax({
                       ...
                       success: function (result) {
                           $("#WHSCommonDtGrid").setGridParam({ datatype: "json" }).trigger('reloadGrid');
                           ...
                           var selectedRowId = $("#WHSCommonGrid").jqGrid("getGridParam", 'selrow');
                           row_id = $("#WHSCommonGrid").getRowData(selectedRowId);
                           $("#dc_mt_cd").val(row_id.mt_cd);
                           $("#dc_mt_nm").val(row_id.mt_nm);
