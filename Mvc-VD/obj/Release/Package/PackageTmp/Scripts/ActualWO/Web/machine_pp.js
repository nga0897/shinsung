            ...
            ({
                ...
                colModel: [
                  { key: true, label: 'mmo', name: "mno", width: 80, align: 'center', hidden: true },
                   { key: false, label: 'Type', name: 'mc_type', width: 60, align: 'center' },
                    { key: false, label: 'Code', name: 'mc_no', width: 100, align: 'left', sort: true },
                    { key: false, label: 'Name', name: 'mc_nm', width: 80, align: 'left' },
                    { key: false, label: 'Purpose', name: 'purpose', width: 140, align: 'left' },
                          { key: false, label: 'Use', name: 'su_dung', width: 80, align: 'left' },
                   { key: false, label: 'Create User', name: 'reg_id', width: 90, align: 'center' },
                   { key: false, label: 'Create Date', name: 'reg_dt', align: 'center', width: 130, formatter: 'date', formatoptions: { srcformat: "ISO8601Long", newformat: "Y-m-d H:i:s" } },
                   { key: false, label: 'Chage User', name: 'chg_id', width: 90, align: 'center' },
                    { key: false, label: 'Chage Date', name: 'chg_dt', align: 'center', width: 130, formatter: 'date', formatoptions: { srcformat: "ISO8601Long", newformat: "Y-m-d H:i:s" } }
                ],
