...
$(".poupdialogsstyleno").click(function () {
...
$("#deletestyle").click(function () {
    $.ajax({
        ...
        success: function (data) {
            if (data.result != 0) {
                jQuery("#issueGrid").setGridParam({ datatype: "json" }).trigger('reloadGrid');
            }
            else {
                alert('Issue was not existing. Please check again');
            }
