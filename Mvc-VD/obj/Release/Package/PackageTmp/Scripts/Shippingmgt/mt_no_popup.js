        ...
        open: function (event, ui) {
            ...
            ({
                ...
                colModel: [
                   ...
                   { label: 'Material Name', name: 'mt_nm', sortable: true, width: 100, align: 'left' },
                   { label: 'mf_cd', name: 'mf_cd', sortable: true, width: 100, align: 'left' },
                   { label: 'sp_cd', name: 'sp_cd', width: 100, align: 'left' },
