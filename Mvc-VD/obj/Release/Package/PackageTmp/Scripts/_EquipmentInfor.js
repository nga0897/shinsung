...
({
    ...
    colModel: [
        ...
        { label: 'Asset No', name: 'as_no', width: 90, align: 'center' },
        { label: 'Equip Code', name: 'as_cd', width: 90, align: 'center' },
        { label: 'Equip Name', name: 'as_nm', width: 90, align: 'center' },
        { label: 'Cost Center ', name: 'cost_dept_cd', width: 120 },
        { label: 'Buying Date', name: 'puchs_dt', width: 80, align: 'center' },
    ...
    gridComplete: function () {
        ...
        for (var i = 0; i < rows.length; i++) {
            var v_use_yn = $("#Equipment").getCell(rows[i], "use_yn");
            if (v_use_yn == "N") {
