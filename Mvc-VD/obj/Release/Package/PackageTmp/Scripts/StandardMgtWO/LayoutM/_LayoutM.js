...
$("#c_save_but").click(function () {
    ...
    $.ajax({
        url: "/StandardMgtWO/insertLayoutMT",
        type: "get",
        dataType: "json",
        data: {
            ml_cd: ml_cd,
...
$("#m_save_but").click(function () {
    ...
    $.ajax({
        url: "/StandardMgtWO/updateLayoutMT",
        type: "get",
        dataType: "json",
        data: {
            m_lmno: $('#m_lmno').val(),
...
function btn_save_gr(e) {
    ...
    $.ajax({
        url: "/StandardMgtWO/saveLayoutDT",
        type: "post",
        dataType: "json",
        data: {
            ldno: $(e).data("ldno"),
...
function btn_del_gr(id) {
    ...
    console.log(stt);
    $.ajax({
        url: "/StandardMgtWO/deleteLayoutDT?id=" + stt,
        type: "post",
        dataType: "json",
        success: function (data) {
