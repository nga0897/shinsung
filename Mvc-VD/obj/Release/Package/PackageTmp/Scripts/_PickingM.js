$(function () {
    ...
    ({
        ...
        colModel: [
            ...
            { key: false, label: 'Material code', name: 'mt_cd', sortable: true, width: '200', align: 'center' },
    ...
    //        var v_wmtid = ret.wmtid;
    //        var v_lct_cd = ret.lct_cd;
    //        $.ajax({
    //            type: "post",
    //            dataType: 'text',
    //            url: "/ReceivingMgt/UpdatePutin",
    //            headers: {
        ...
        if (fun_check1() == true) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    //jQuery("#picMGrid").setGridParam({ rowNum: 20, datatype: "json" }).trigger('reloadGrid');
                }
            });
        }
