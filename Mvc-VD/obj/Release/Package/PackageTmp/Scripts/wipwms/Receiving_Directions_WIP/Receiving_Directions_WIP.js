...
$(function () {
    $("#list1").jqGrid
    ({
        url: "/wipwms/getshipinfo_Directions_WIP",
        datatype: 'json',
        mtype: 'Get',
        colModel: [
             ...
             { label: 'States', name: 'sd_sts_cd', width: 100, align: 'left' },
        ...
        onSelectRow: function (rowid, selected, status, e) {
            ...
            $('#m_sd_no').val(sd_no);
            $("#list2").clearGridData();
            $("#list2").setGridParam({ url: "/wipwms/getReDetails_Directions_WIP?" + "sd_no=" + sd_no, datatype: "json" }).trigger("reloadGrid");
            $("#list3").setGridParam({ url: "/wipwms/getship3_Directions_WIP?" + "sd_no=" + sd_no, datatype: "json" }).trigger("reloadGrid");
        },
...
function Title(sid) {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $("#title1").html("<h1 style='font-size: 43px;'>Picking Direction</h1><h2 style='font-size: 20px;'>" + result.sd_no + " " + '[' + result.lct_cd + " " + ']' + "</h2>");
        },
    });
...
$(function () {
    $("#list2").jqGrid
    ({
        url: "/wipwms/getReDetails_Directions_WIP",
        datatype: 'json',
        mtype: 'Get',
        colModel: [
             ...
             { label: 'Pick Qty', name: 'd_mt_qty', width: 110, align: 'right', formatter: 'integer' },
...
$(function () {
    $("#list3").jqGrid
    ({
        url: "/wipwms/getship3_Directions_WIP",
        datatype: 'json',
        mtype: 'Get',
        colModel: [
...
$("#searchBtn").click(function () {
    ...
    $.ajax({
        url: "/wipwms/searchRequest_Directions_WIP",
        type: "get",
        dataType: "json",
        data: {
            sd_no: sd_no,
