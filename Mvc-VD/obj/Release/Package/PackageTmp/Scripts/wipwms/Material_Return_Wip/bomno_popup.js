    ...
    open: function (event, ui) {
        ...
        ({
            ...
            colModel: [
                ...
                { key: false, label: 'Code', name: 'bom_no', width: 150, align: 'center', formatter: formatter_bom },
...
function formatter_bom(cellvalue, options, rowObject) {
    var a, b, c, d;
