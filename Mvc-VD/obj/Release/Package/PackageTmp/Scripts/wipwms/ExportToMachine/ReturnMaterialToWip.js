        ...
        ({
            ...
            colModel: [
               ...
               /* { label: 'Lot No', name: 'lot_no', width: 100, align: 'left' },*/
                ...
                { label: 'Machine', name: 'LoctionMachine', width: 130, align: 'center' },
...
$("#scan_mt_cd").on("keydown", function (e) {
    if (e.keyCode === 13) {
        ...
        $.ajax({
            url: "/ExportToMachine/GetReturn_ScanMLQR_WIP",
            type: "get",
            dataType: "json",
            data: {
...
$("#Save_completed").on("click", function () {
    ...
    $.ajax({
        url: "/ExportToMachine/UpdateReturnMaterialToMachine?ListId="+ rows,
        type: "get",
        dataType: "json",
        data:
        {
