...
$(function () {
    ...
    $grid = $("#Directions").jqGrid({
        url: '/fgwms/GetDirections_WIP',
        mtype: 'GET',
        datatype: 'json',
        colModel: [
            { key: true, label: 'sdid', name: 'sdid', width: 50, hidden: true },
            { label: 'SD NO', name: 'sd_no', width: 110, align: 'center' },
            { label: 'Material No', name: 'mt_no', width: 180, align: 'left' },
            { label: 'Material Name', name: 'mt_nm', width: 180, align: 'left' },
...
var getadmin = "/fgwms/getadmin";


//LƯỚI LƯU
$(function () {
    $grid = $("#State").jqGrid({
        url: '/fgwms/Getw_rd_info_WIP',
        mtype: 'GET',
        datatype: 'json',
        colModel: [
...
//search
var wh = "/fgwms/lct_destination_WIP";
...
$("#Direction").click(function () {
    ...
    if ($("#uname").val().trim() == "") {
        ...
        $.ajax({
            url: "/fgwms/insert_rd_info_WIP?" + "id=" + selRowIds,
            type: "post",
            dataType: "json",
            data: {
                lct_cd: $('#whouse').val(),
