...
//            { key: false, label: 'Qty', name: 'gr_qty', width: 100, align: 'right', formatter: 'integer' },
...
//           { key: false, label: 'Departure', name: 'from_lct_cd', editable: true, width: '100px', align: 'center' },
...
//            { key: false, label: 'WO', name: 'fo_no', editable: true, width: '180', align: 'center' },
//            { key: false, label: 'BOM', name: 'bom_no', editable: true, width: '100px', align: 'center' },
//            { key: false, label: 'Routing', name: 'line_no', editable: true, width: '150', align: 'center', },
...
//    $.ajax({
//        url: "/fgwms/searchProLotShippList",
//        type: "get",
//        dataType: "json",
//        data: {
//            prd_lcd: prd_lcd,
...
$(function () {
    ...
    ({
        ...
        colModel: [
            ...
            { key: false, label: 'Location', name: 'to_lct_cd', editable: true, width: '100px', align: 'left' },
            //{ key: false, label: 'Location', name: 'lct_cd', editable: true, width: '100px', align: 'left' },
            ...
            { key: false, label: 'Output Date', name: 'output_dt', editable: true, width: '100px', align: 'center', formatter: formatdate },
            //{ key: false, label: 'Destination', name: 'to_lct_cd', editable: true, width: '100px', align: 'center' },
