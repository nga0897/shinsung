...
$("#list").jqGrid
    ({
        ...
        colModel: [
            ...
            { label: 'Name', name: 'mt_nm', sortable: true, width: 300, },
            ...
            { label: 'Manufactory', name: 'mf_cd', sortable: true, width: 150, align: 'left', },
            { label: 'Area(m²)', name: 'area_all', width: 150, align: 'right', formatter: areaformat },////
            ...
            { label: 'Consumable', name: 'consumable', width: 150, align: 'center' },////
            ...
            { label: 'Stickness(g)', name: 'stick_new', width: 150, align: 'right', formatter: stickformat },///
            { label: 'Hidden', name: 'stick', width: 60, align: 'right', hidden: true },
            { label: 'Hidden', name: 'stick_unit', width: 60, align: 'right', hidden: true },
            { label: 'Thickness(µm)', name: 'thick_new', width: 150, align: 'right', formatter: thickformat },///
            ...
            { label: 'QC Code', name: 'item_vcd', sortable: true, width: 100, align: 'left' },
            { label: 'QC Name', name: 'item_nm', sortable: true, width: 100, align: 'left' },
            { label: 'QC Range', name: 'qc_range_cd_nm', sortable: true, width: 100, align: 'left' },
...
$('#excelBtn').click(function () {
    ...
    var end = $("#end1").val();
    $('#exportData').attr('action', "/DevManagement/ExportToExcel?type=" + type + "&code=" + code + "&name=" + name + "&start=" + start + "&end=" + end);
});
