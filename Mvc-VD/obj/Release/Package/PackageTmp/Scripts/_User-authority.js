$(function () {
    ...
    ({
       ...
       colModel: [
           ...
           { key: false, label: 'e_mail', name: 'e_mail', index: 'e_mail', editable: true, width: '150', align: 'left' },
           { key: false, label: 'lctno', name: 'lct_cd', index: 'lct_cd', editable: true, width: '120', align: 'center' },
           { key: false, label: 'reg_name', name: 'reg_id', index: 'reg_id', editable: true, width: '100px' },
           { key: false, label: 'reg_dt', name: 'reg_dt', index: 'reg_dt', editable: true, align: 'center', formatter: 'date', formatoptions: { newformat: 'y-m-d h:m:s' }, width: '200' },
           { key: false, label: 'chg_id', name: 'chg_id', index: 'chg_id', editable: true, width: '100px' },
           { key: false, label: ' chg_dt', name: 'chg_dt', index: 'chg_dt', editable: true, align: 'center', formatter: 'date', formatoptions: { newformat: 'y-m-d h:m:s' }, width: '200' },
       ],
       pager: '#gridpager',
